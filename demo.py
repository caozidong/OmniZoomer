...
if __name__ == '__main__':
    ...
    # python demo.py --input /home/ps/data/zidongcao/Dataset/Flickr360_val/LR/X4/03008.png --model save/_train_rcan-x4/epoch-best.pth --scale 4 --output test.png --gpu 6